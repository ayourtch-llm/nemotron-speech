...
│       ├── transcribe_live.rs       AudioSource-driven (file / mic / udp-listen)
│       ├── udp_mic_send.rs     mic -> raw f32-LE 16k UDP packets (companion sender)
│       └── subsample_check.rs  Streaming-subsample diff vs offline forward()
```
